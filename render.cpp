...
void Render::DrawImage(const Image& im, const Point2f& pos)
{
    ...
    glPushMatrix();
        ...
        glTexCoord2f(0 ,1); glVertex2i (0  ,r.right_bottom.y);
        glTexCoord2f(1 ,1); glVertex2i (r.right_bottom.x,r.right_bottom.y);
        glTexCoord2f(1,0);  glVertex2i (r.right_bottom.x,0);
        glEnd();
    glPopMatrix();
}
